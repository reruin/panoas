 ...
 * 
 * version log:
 *  10.07.03		2.2+	Tiny			+ Add a style for bground alpha
 *
...
package pano.utils{
	...
	{	
		...
		protected var theme : Object = { bg: 0x33FFFFFF, fps: 0xffff00, ms: 0x00ff00, mem: 0x00ffff, memmax: 0xff0070 , pos : 0}; 
		...
		public function Stats( _theme : Object = null ) : void
		{
			if (_theme)
			{
				...
				if (_theme.pos != null) theme.pos = _theme.pos;
				
			}
			theme.alpha = (theme.bg >> 24) /255
		...
		private function init(e : Event) : void
		{
			...
			graphics.beginFill(theme.bg,theme.alpha);
			graphics.drawRect(0, 0, WIDTH, HEIGHT);
			graphics.endFill();

			addChild(text);
			
			graph.bitmapData = new BitmapData(WIDTH, HEIGHT - 50, true, theme.bg);
			addChild(graph);
