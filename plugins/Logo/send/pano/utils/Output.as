package pano.utils
{
    ...
    public class Output extends Sprite
    {
        ...
        public function Output(s:Stage = null)
        {
        ...
        public function recalcLayout(event:Event = null) : void
        {
            ...
            this.output_txt.height = Output.output_h;
            this.output_bg.height = Output.output_h;
        ...
        private function keyDownHandler(event:KeyboardEvent) : void
        {
			...
			//[O] for toggle self
            if (Output.keyb && code == 79)  Output.toggle();
			
			//[C] for clear text
			if (Output.keyb && code == 67) output_txt.text = "";
		...
		public static function trace(param1:int, ... args) : void
        {
            ...
            if(param1 == 0 && Output.debugmode == false)  return;
			//Output.t("h")
